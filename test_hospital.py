...
if __name__ == "__main__":
    ...
    print(f"[Timing] Static optimisation took {t1 - t0:.2f} seconds")
    ...
    print(f"[Timing] Dynamic emergency replan took {t3 - t2:.2f} seconds")
    ...
    print(f"[Timing] Dynamic overrun replan took {t5 - t4:.2f} seconds")
